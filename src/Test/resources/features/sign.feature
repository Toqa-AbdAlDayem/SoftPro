Feature: Signup
  ...
  Scenario:  Successful Sign Up with Minimal Information
    ...
    And they fill in the registration form with a valid username "tot2" and a strong password "555" and a correct confirmpass "555" and a correct email "ahmadomar24@gmail.com" and Birthdate "1999-2-1" and Gender "Male"

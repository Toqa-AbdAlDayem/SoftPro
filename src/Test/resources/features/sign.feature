Feature: Signup
  ...
  Scenario:  Successful Sign Up with Minimal Information
    ...
    And they fill in the registration form with a valid username "Ahmad23" and a strong password "secure123ahmad" and a correct confirmpass "secure123ahmad" and a correct email "ahmadomar24@gmail.com" and Birthdate "1999-2-1" and Gender "Male"
